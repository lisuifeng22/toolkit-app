...
export function NoteScreen() {
  ...
  const renderItem = ({ item }: { item: Note }) => (
    ...
    >
      ...
      <Text style={styles.noteDate}>{new Date(item.updatedAt).toLocaleDateString('zh-CN')}</Text>
    </TouchableOpacity>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <TouchableOpacity style={styles.fab} activeOpacity={0.85} onPress={() => navigation.navigate('NoteEditor', {})}>
